Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "scoutaround_#{Rails.env}"
...
SanitizeEmail::Config.configure do |config|
  config[:sanitized_to] =         'ray@bradleys.io'
  config[:sanitized_cc] =         'ray@bradleys.io'
  config[:sanitized_bcc] =        'ray@bradleys.io'
